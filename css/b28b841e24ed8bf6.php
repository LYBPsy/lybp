...
.Home_noWrapForce__ZVcGp {
    white-space: nowrap !important
}

.Home_avatar__Nx8VL {
    border-radius: 100%;
    border: 3px solid #5297dd !important
}
...
.Home_tableIconTd__XPlmO {
    padding: .25rem !important
}

.Home_tableIcons__NIcFZ {
    display: flex;
    width: 27px
}

.Home_biliIcon__vAY_x {
    width: 20px;
    vertical-align: text-bottom
}

.Home_categorySelectionContainer__xmJCY {
    border: 3px solid #1d0c26;
    border-radius: 1rem;
    padding: 1rem
}
...
@media (min-width:1201px) {
    .Home_outerContainer__cYXfd {
        <!-- background: url(../img/tipsy.webp) 50% no-repeat fixed; -->
    ...
    .Home_titleCol__7_LXx:hover .Home_introBox__95Aha {
        opacity: 1
    }

    .Home_titleCol__7_LXx:hover .Home_titleBox__Q6Ce_ {
